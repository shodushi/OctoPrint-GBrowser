...
$(function() {
    ...
    function gbrowserViewModel(parameters) {
        var self = this;

        self.API_BASEURL = "plugin/gbrowser/";
        ...
        self.getEntryId = function(data) {
            return "gbrowser_entry_" + md5(data["origin"] + ":" + data["name"]);
        };
...
*/
    ...
    OCTOPRINT_VIEWMODELS.push([
        ...
        ["#tab_plugin_gbrowser", "#gbrowserNameDialog"]
    ]);
});